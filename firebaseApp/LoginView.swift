...
class LoginView: UIViewController {
    ...
    lazy var titleLabel = viewBuilder.createLabel(frame: CGRect(x: 30, y: 100, width: view.frame.width - 60, height: 40), text: "Authorization", size: 22)
    ...
    lazy var regBtn = viewBuilder.createButton(frame: CGRect(x: 30, y: view.frame.height - 150, width: view.frame.width - 60, height: 50), action: loginAction, title: "Log in", isMainBtn: true)
    lazy var logBtn = viewBuilder.createButton(frame: CGRect(x: 30, y: regBtn.frame.maxY + 10, width: view.frame.width - 60, height: 50), action: regAction, title: "Sign up")
